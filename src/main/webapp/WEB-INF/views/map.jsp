...
<head>
  ...
  <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJBRTp3Y0iJppaKELytW_tmBrF2DDqCpg&callback=console.debug&libraries=maps,marker&v=beta">
...
<body>
  ...
  <div class="page-wrapper-2">
    ...
    <div class="map_div">
      <gmp-map center="38.70125961303711,-9.334271430969238" zoom="14" map-id="Gmap">
        <gmp-advanced-marker position="38.70125961303711,-9.334271430969238" title="My location">
        </gmp-advanced-marker>
      </gmp-map>
    </div>
    <div class="footer">
