  ...
  <div class="w-users-userformpagewrap full-page-wrapper">
    ...
    <div class="w-users-usersignupformwrapper admin-form-card">
      <div tab="-1" class="w-users-userformsuccessstate verification-box w-form-success">
        ...
        <a href="/index/login" class="button w-button">Go to login</a>
      </div>
      <form method="post" action="/auth/register">
        <div class="w-users-userformheader form-card-header">
          <h2 class="heading h3">Sign up</h2>
        </div>
        <input type="email" id="wf-sign-up-email" placeholder="Your email" maxlength="256" name="Email" class="text-field w-input" autocomplete="username" required="" data-wf-user-form-input-type="email">
        <input type="text" class="text-field w-input" maxlength="256" name="Name" data-name="field" data-wf-user-field="wf-user-field-name" placeholder="Your Name" fieldtype="" id="wf-sign-up-name" required="">
        <input type="password" id="wf-sign-up-password" placeholder="Your password" maxlength="256" name="Password" class="text-field w-input" required="" data-wf-user-form-input-type="password">
        <label class="w-checkbox checkbox-field">
          <input type="checkbox" class="w-checkbox-input check-box" name="Checkbox" data-name="Checkbox" data-wf-user-field="wf-user-field-accept-privacy" placeholder="" id="wf-sign-up-accept-privacy" required="">
        ...
        <input type="submit" value="Sign Up" data-wait="Please wait..." class="w-users-userformbutton button w-button">
      ...
      <div tabindex="-1" class="w-users-usersignupverificationmessage verification-box w-form-verification" data-wf-user-form-verification="true">
