...
<body>
    ...
    <div class="uui-navbar07_container-2">
      <a href="#" class="uui-navbar07_logo-link-2 w-nav-brand">
        <div class="uui-logo_component-2">
          <a href="/index/">
            <img src="/images/Untitled-design-26_1.png" loading="lazy" width="Auto" id="plume-home" alt="" class="uui-logo_logotype-2">
          </a>
        </div>
      </a>
      <div role="navigation" class="uui-navbar07_menu-2 w-nav-menu">
        <div class="uui-navbar07_menu-left-2">
          ...
          <a href="/index/our-team" aria-current="page" class="uui-navbar07_link-2 w-nav-link w--current">Our Team</a>
        </div>
  ...
  <div class="team-section">
    <div class="team-heading">
      <h2>Meet the Team</h2>
      <p class="spark-secondary-paragraph">Meet the passionate team behind Plume, a blend of ornithologists, developers, designers, and marketers. Each contributes unique skills and expertise, making Plume more than just an app. Get to know the individuals dedicated to enhancing your birdwatching experience.</p>
    </div>
    <div class="team-grid">
      <div id="w-node-_1e5719c8-07f6-9a95-cd0c-f07fc20c3750-6e2eeead" class="team-card spark-stacked">
        <a href="#" class="w-inline-block"><img src="/images/avatar-50_1avatar-50.webp" loading="eager" width="80" alt="" class="team-images"></a>
      ...
      <div id="w-node-_1e5719c8-07f6-9a95-cd0c-f07fc20c375d-6e2eeead" class="team-card spark-stacked">
        <a href="#" class="w-inline-block"><img src="/images/avatar-45_1avatar-45.webp" loading="eager" width="80" alt="" class="team-images"></a>
        <div class="team-member-details">
      ...
      <div id="w-node-_1e5719c8-07f6-9a95-cd0c-f07fc20c376a-6e2eeead" class="team-card spark-stacked">
        <a href="#" class="w-inline-block"><img src="/images/avatar-40_1avatar-40.webp" loading="eager" width="80" alt="" class="team-images"></a>
        <div class="team-member-details">
      ...
      <div id="w-node-_1e5719c8-07f6-9a95-cd0c-f07fc20c3777-6e2eeead" class="team-card spark-stacked">
        <a href="#" class="w-inline-block"><img src="/images/avatar-38_1avatar-38.webp" loading="eager" width="80" alt="" class="team-images"></a>
        <div class="team-member-details">
