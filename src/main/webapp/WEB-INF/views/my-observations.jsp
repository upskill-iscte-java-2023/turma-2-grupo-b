      ...
      <div data-collapse="medium" data-animation="default" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" class="navbar-2 w-nav">
        <div class="navbar-container">
          ...
          <nav role="navigation" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a3c-f8957a37" class="navbar2_menu is-page-height-tablet w-nav-menu">
            <a href="../profile-2/profile-dashboard.html" class="navbar2_link w-nav-link">Dashboard</a>
            <a href="../profile-2/plume-wiki.html" class="navbar2_link w-nav-link">Plume Wiki</a>
            <a href="../profile-2/payments.html" class="navbar2_link w-nav-link">Rewards placeholder 🪶</a>
            ...
            <div class="padding-section-small">
              <div class="w-layout-grid content-grid">
                <div id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c069dc-6e2eeeab" class="sidebar-content">
                  <div class="side-bar">
                    <div class="w-layout-grid sidebar-menu-grid">
                      <a href="../profile-2/profile-dashboard.html" id="w-node-_7236d477-f2fc-a836-5bb8-3f0f4be62a66-4be62a64" class="sidebar-menu-item w-inline-block">
                        <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.12598 14C8.57002 15.7252 10.1361 17 12 17C13.8638 17 15.4299 15.7252 15.874 14" stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M3 10.5651C3 9.9907 3 9.70352 3.07403 9.43905C3.1396 9.20478 3.24737 8.98444 3.39203 8.78886C3.55534 8.56806 3.78202 8.39175 4.23539 8.03912L11.0177 2.764C11.369 2.49075 11.5447 2.35412 11.7387 2.3016C11.9098 2.25526 12.0902 2.25526 12.2613 2.3016C12.4553 2.35412 12.631 2.49075 12.9823 2.764L19.7646 8.03913C20.218 8.39175 20.4447 8.56806 20.608 8.78886C20.7526 8.98444 20.8604 9.20478 20.926 9.43905C21 9.70352 21 9.9907 21 10.5651V17.8C21 18.9201 21 19.4801 20.782 19.908C20.5903 20.2843 20.2843 20.5903 19.908 20.782C19.4802 21 18.9201 21 17.8 21H6.2C5.07989 21 4.51984 21 4.09202 20.782C3.71569 20.5903 3.40973 20.2843 3.21799 19.908C3 19.4801 3 18.9201 3 17.8V10.5651Z" stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          </svg></div>
                      ...
                      <a href="../profile-2/my-observations.html" id="w-node-_7236d477-f2fc-a836-5bb8-3f0f4be62a6a-4be62a64" aria-current="page" class="sidebar-menu-item w-inline-block w--current">
                        <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.5 13L7.28446 14.5689C7.54995 15.0999 7.68269 15.3654 7.86003 15.5954C8.01739 15.7996 8.20041 15.9826 8.40455 16.14C8.63462 16.3173 8.9001 16.4501 9.43108 16.7155L11 17.5L9.43108 18.2845C8.9001 18.5499 8.63462 18.6827 8.40455 18.86C8.20041 19.0174 8.01739 19.2004 7.86003 19.4046C7.68269 19.6346 7.54995 19.9001 7.28446 20.4311L6.5 22L5.71554 20.4311C5.45005 19.9001 5.31731 19.6346 5.13997 19.4046C4.98261 19.2004 4.79959 19.0174 4.59545 18.86C4.36538 18.6827 4.0999 18.5499 3.56892 18.2845L2 17.5L3.56892 16.7155C4.0999 16.4501 4.36538 16.3173 4.59545 16.14C4.79959 15.9826 4.98261 15.7996 5.13997 15.5954C5.31731 15.3654 5.45005 15.0999 5.71554 14.5689L6.5 13Z" stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="
id="w-node-_7236d477-f2fc-a836-5bb8-3f0f4be62a7a-4be62a64" class="sidebar-menu-item w-inline-block">
                        <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22 10H2M22 11V8.2C22 7.0799 22 6.51984 21.782 6.09202C21.5903 5.7157 21.2843 5.40974 20.908 5.21799C20.4802 5 19.9201 5 18.8 5H5.2C4.0799 5 3.51984 5 3.09202 5.21799C2.7157 5.40973 2.40973 5.71569 2.21799 6.09202C2 6.51984 2 7.0799 2 8.2V15.8C2 16.9201 2 17.4802 2.21799 17.908C2.40973 18.2843 2.71569 18.5903 3.09202 18.782C3.51984 19 4.07989 19 5.2 19H11.5M18 21C18 21 21 19.5701 21 17.4252V14.9229L18.8124 14.1412C18.2868 13.9529 17.712 13.9529 17.1864 14.1412L15 14.9229V17.4252C15 19.5701 18 21 18 21Z" stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          </svg></div>
                        <div>Rewards</div>
                  ...
                  <div class="inner-content">
                    <div class="inner-content-group">
                      <div class="page-title-group">
                        ...
                        <p class="text-color-grey">2 out of 4 collections created, <a href="../profile-2/subscriptions.html" class="text-weight-medium text-color-primary action-link">upgrade for more collections</a>
                        </p>
                      </div>
                      ...
                      <div class="collection">
                        ...
                        <div class="w-layout-grid _3-col-grid scroll-grid">
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a18-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="/static/images/My-Observations_Img1.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/My-Observations_Img1.png 500w, ../images/My-Observations_Img1.png 800w, ../images/My-Observations_Img1.png 844w" alt="" class="art-image">
                          ...
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a1c-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="../images/My-Observations_Img2.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/My-Observations_Img2.png 500w, ../images/My-Observations_Img2.png 800w, ../images/My-Observations_Img2.png 844w" alt="" class="art-image">
                              <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="32" height="32" rx="8" fill="white"></rect>
                                  <path d="M13.3333 19.3333L15.9999 22M15.9999 22L18.6666 19.3333M15.9999 22V16M21.3333 19.1619C22.1476 18.4893 22.6666 17.4719 22.6666 16.3333C22.6666 14.3083 21.025 12.6667 18.9999 12.6667C18.8543 12.6667 18.718 12.5907 18.644 12.4652C17.7747 10.9899 16.1695 10 14.3333 10C11.5718 10 9.33325 12.2386 9.33325 15C9.33325 16.3774 9.89022 17.6247 10.7912 18.529" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></div>
                          ...
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a20-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="../images/My-Observations_Img3.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/My-Observations_Img3.png 500w, ../images/My-Observations_Img3.png 800w, ../images/My-Observations_Img3.png 844w" alt="" class="art-image">
                              <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="32" height="32" rx="8" fill="white"></rect>
                                  <path d="M13.3333 19.3333L15.9999 22M15.9999 22L18.6666 19.3333M15.9999 22V16M21.3333 19.1619C22.1476 18.4893 22.6666 17.4719 22.6666 16.3333C22.6666 14.3083 21.025 12.6667 18.9999 12.6667C18.8543 12.6667 18.718 12.5907 18.644 12.4652C17.7747 10.9899 16.1695 10 14.3333 10C11.5718 10 9.33325 12.2386 9.33325 15C9.33325 16.3774 9.89022 17.6247 10.7912 18.529" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></div>
                      ...
                      <div class="collection">
                        ...
                        <div class="w-layout-grid _3-col-grid scroll-grid">
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a3a-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="../images/Beach Observations_1.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/Beach-Observations_1.png 500w, ../images/Beach-Observations_1.png 800w, ../images/Beach-Observations_1.png 844w" alt="" class="art-image">
                              <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="32" height="32" rx="8" fill="white"></rect>
                                  <path d="M13.3333 19.3333L15.9999 22M15.9999 22L18.6666 19.3333M15.9999 22V16M21.3333 19.1619C22.1476 18.4893 22.6666 17.4719 22.6666 16.3333C22.6666 14.3083 21.025 12.6667 18.9999 12.6667C18.8543 12.6667 18.718 12.5907 18.644 12.4652C17.7747 10.9899 16.1695 10 14.3333 10C11.5718 10 9.33325 12.2386 9.33325 15C9.33325 16.3774 9.89022 17.6247 10.7912 18.529" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></div>
                          ...
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a3e-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="../images/Beach Observations_2.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/Beach-Observations_2.png 500w, ../images/Beach-Observations_2.png 800w, ../images/Beach-Observations_2.png 844w" alt="" class="art-image">
                              <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="32" height="32" rx="8" fill="white"></rect>
                                  <path d="M13.3333 19.3333L15.9999 22M15.9999 22L18.6666 19.3333M15.9999 22V16M21.3333 19.1619C22.1476 18.4893 22.6666 17.4719 22.6666 16.3333C22.6666 14.3083 21.025 12.6667 18.9999 12.6667C18.8543 12.6667 18.718 12.5907 18.644 12.4652C17.7747 10.9899 16.1695 10 14.3333 10C11.5718 10 9.33325 12.2386 9.33325 15C9.33325 16.3774 9.89022 17.6247 10.7912 18.529" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></div>
                          ...
                          <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a42-6e2eeeab" href="#" class="w-inline-block">
                            <div class="art-card"><img src="../images/Beach Observations_3.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 991px) 89vw, (max-width: 1279px) 66vw, 736.1875px" srcset="../images/Beach-Observations_3.png 500w, ../images/Beach-Observations_3.png 800w, ../images/Beach-Observations_3.png 844w" alt="" class="art-image">
                              <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="32" height="32" rx="8" fill="white"></rect>
                                  <path d="M13.3333 19.3333L15.9999 22M15.9999 22L18.6666 19.3333M15.9999 22V16M21.3333 19.1619C22.1476 18.4893 22.6666 17.4719 22.6666 16.3333C22.6666 14.3083 21.025 12.6667 18.9999 12.6667C18.8543 12.6667 18.718 12.5907 18.644 12.4652C17.7747 10.9899 16.1695 10 14.3333 10C11.5718 10 9.33325 12.2386 9.33325 15C9.33325 16.3774 9.89022 17.6247 10.7912 18.529" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></div>
