                                ...
                                <div class="inner-content">
                                    ...
                                    <div class="inner-content-group">
                                        ...
                                        <div class="w-layout-grid _3-col-grid art-grid">
                                            <div id="w-node-_0e82330e-8d82-60cb-f282-3dd96d6531ec-6e2eeeb5"
                                                 class="art-card"><img src="/images/Rectangle-11_1.png" loading="lazy"
                                                                       alt="" class="art-image">
                                                <div class="art-card-context">
                                                    <div class="content-wrap">
                                                        <h2 class="heading-style-h5">Winter sports</h2>
                                                        <p class="text-color-grey p-desc">Generate a futuristic winter
                                                            sports man...</p>
                                                    </div>
                                                    <div data-hover="false" data-delay="0"
                                                        ...
                                                        <nav class="dropdown-list w-dropdown-list">
                                                            <a href="#" class="dd-link w-dropdown-link">Share
                                                                collection</a>
                                            ...
                                            <div id="w-node-_0e82330e-8d82-60cb-f282-3dd96d653200-6e2eeeb5"
                                                 class="art-card"><img src="/images/Rectangle-11_2.png" loading="lazy"
                                                                       alt="" class="art-image">
                                                <div class="art-card-context">
                                                    <div class="content-wrap">
                                                        <h2 class="heading-style-h5">AI bot assistant</h2>
                                                        <p class="text-color-grey p-desc">Create a starwars-like ai
                                                            assistant with legs</p>
                                                    </div>
                                                    <div data-hover="false" data-delay="0"
                                                         class="option-menu w-dropdown">
                                                        <div class="dropdown-toggle w-dropdown-toggle">
