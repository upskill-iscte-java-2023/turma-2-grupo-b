            ...
            <div class="mobile-menu-wrap-side">
              <div class="side-bar">
                <div class="w-layout-grid sidebar-menu-grid">
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a46-f8957a37" class="sidebar-menu-item w-inline-block">
                  ...
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a4a-f8957a37" class="sidebar-menu-item w-inline-block">
                    <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a4e-f8957a37" class="sidebar-menu-item w-inline-block">
                    <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a52-f8957a37" class="sidebar-menu-item w-inline-block">
                    <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a56-f8957a37" class="sidebar-menu-item w-inline-block">
                    <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a5a-f8957a37" class="sidebar-menu-item w-inline-block">
                    <div class="sidemenu-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="content-wrap margin-top margin-medium">
                <div class="w-layout-grid _3-col-grid art-grid _4-col">
                  ...
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe2f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-2.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      <a href="#" class="flex-box w-inline-block">
                        <div class="profile-link smaller"><img src="../images/Ellipse-2-1_1Ellipse-2-1.png" loading="lazy" alt="" class="profile-link-image"></div>
                        <div class="text-size-small text-weight-semibold">Dick Greyson</div>
                      </a>
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Heaven gate</h2>
                        <p class="text-color-grey p-desc">Gate to heaven but with polygons and a pyramid</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe3f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-4.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      <a href="#" class="flex-box w-inline-block">
                        <div class="profile-link smaller"><img src="../images/Ellipse-2-2_1Ellipse-2-2.png" loading="lazy" alt="" class="profile-link-image"></div>
                        <div class="text-size-small text-weight-semibold">James Newman</div>
                      </a>
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Graduation pack</h2>
                        <p class="text-color-grey p-desc">A modern graduation pack set with cert and hat</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe4f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-14.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      <a href="#" class="flex-box w-inline-block">
                        <div class="profile-link smaller"><img src="../images/Ellipse-2-3_1Ellipse-2-3.png" loading="lazy" alt="" class="profile-link-image"></div>
                        <div class="text-size-small text-weight-semibold">Lack Xetter</div>
                      </a>
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Zombie robot</h2>
                        <p class="text-color-grey p-desc">Humanoid robots but with a zombie appearance</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe5f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-8.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Robot apocalypse</h2>
                        <p class="text-color-grey p-desc">A robot from the apocalypse with light eyes</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe6f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-10.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Afro Tecno</h2>
                        <p class="text-color-grey p-desc">An african with techno wears on their face</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe7f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-6.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Afro Tecno 2</h2>
                        <p class="text-color-grey p-desc">An african with techno wears on their face</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe8f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-12.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      <a href="#" class="flex-box w-inline-block">
                        <div class="profile-link smaller"><img src="../images/Ellipse-2-3_1Ellipse-2-3.png" loading="lazy" alt="" class="profile-link-image"></div>
                        <div class="text-size-small text-weight-semibold">Yin Lang</div>
                      </a>
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Modern japan flower</h2>
                        <p class="text-color-grey p-desc">Beautiful flowers on a japanese window</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabe9f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-1.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Black man with long afro 2</h2>
                        <p class="text-color-grey p-desc">A black model with long afro staring wild into my eyes</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabeaf-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-3.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Heaven gate 2</h2>
                        <p class="text-color-grey p-desc">Gate to heaven but with polygons and a pyramid</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabebf-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-5.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Graduation pack 2</h2>
                        <p class="text-color-grey p-desc">A modern graduation pack set with cert and hat</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabecf-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-15.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                  ...
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabedf-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-9.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      <a href="#" class="flex-box w-inline-block">
                        <div class="profile-link smaller"><img src="../images/Ellipse-2-4_1Ellipse-2-4.png" loading="lazy" alt="" class="profile-link-image"></div>
                        <div class="text-size-small text-weight-semibold">Lack Xetter</div>
                      </a>
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Robot apocalypse 2</h2>
                        <p class="text-color-grey p-desc">A robot from the apocalypse with light eyes</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabeef-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-11.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Afro Tecno 3</h2>
                        <p class="text-color-grey p-desc">An african with techno wears on their face</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabeff-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-7.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Afro Tecno 4</h2>
                        <p class="text-color-grey p-desc">An african with techno wears on their face</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
                  </div>
                  <div id="w-node-_17034b2c-512c-cefb-60a5-f04579aabf0f-6e2eeeaf" class="art-card with-animation"><img src="../images/Rectangle-11-13.png" loading="lazy" alt="" class="art-image">
                    <div class="action-icon w-embed"><svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="32" height="32" rx="8" fill="white"></rect>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9951 10.478C14.4352 9.11474 12.1282 8.83577 10.3366 10.3665C8.39879 12.0222 8.11723 14.8108 9.64965 16.7827C10.2313 17.5312 11.3667 18.6557 12.4577 19.6856C13.5616 20.7274 14.6629 21.712 15.206 22.193C15.2094 22.196 15.2129 22.199 15.2164 22.2022C15.2674 22.2474 15.331 22.3038 15.3919 22.3496C15.4649 22.4046 15.5696 22.4728 15.7095 22.5145C15.8954 22.57 16.0953 22.57 16.2813 22.5145C16.4211 22.4728 16.5259 22.4046 16.5988 22.3496C16.6597 22.3038 16.7233 22.2474 16.7743 22.2022C16.7779 22.199 16.7813 22.196 16.7847 22.193C17.3278 21.712 18.4291 20.7274 19.533 19.6856C20.6241 18.6557 21.7594 17.5312 22.3411 16.7827C23.8676 14.8184 23.6295 12.0083 21.6471 10.3607C19.8357 8.85503 17.5533 9.11422 15.9951 10.478Z" fill="#E0E0E0"></path>
                      </svg></div>
                    <div class="art-card-context vertical">
                      ...
                      <div class="content-wrap">
                        <h2 class="heading-style-h5">Modern japan flower 2</h2>
                        <p class="text-color-grey p-desc">Beautiful flowers on a japanese window</p>
                      </div>
                    </div>
                    <a href="#" class="button-3 is-small w-button">Remix ✨</a>
