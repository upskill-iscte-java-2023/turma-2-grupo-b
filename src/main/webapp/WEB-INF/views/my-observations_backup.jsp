            ...
            <div class="navbar-container">
                ...
                <div id="w-node-_2cc41a78-d014-b7fd-7229-2969f8957a5e-f8957a37" class="navbar2_button-wrapper">
                    <a href="#" class="profile-link w-inline-block">
                        <img src="/images/profile-image_1profile image.png" loading="lazy" alt=""
                            ...
                            <div id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c069dc-6e2eeeab" class="sidebar-content">
                                <div class="side-bar">
                                    <div class="w-layout-grid sidebar-menu-grid">
                                        ...
                                        <a href="../profile-2/my-observations"
                                        ...
                                        <a href="challenges" id="w-node-_7236d477-f2fc-a836-5bb8-3f0f4be62a6e-4be62a64"
                                           class="sidebar-menu-item w-inline-block">
                                            <div class="sidemenu-icon w-embed">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="payments" id="w-node-_7236d477-f2fc-a836-5bb8-3f0f4be62a7a-4be62a64"
                                           class="sidebar-menu-item w-inline-block">
                                            <div class="sidemenu-icon w-embed">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="collection">
                                            <div class="art-card-context alt">
                                                <div class="content-wrap">
                                                    ...
                                                    <p class="text-color-grey">Generate a futuristic winter sports
                                                        man...</p>
                                                </div>
                                            ...
                                            <div class="w-layout-grid _3-col-grid scroll-grid">
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a18-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img src="/images/Rectangle-12_1.png"
                                                ...
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a1c-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img src="/images/Rectangle-13-1.png"
                                                                               loading="lazy" alt="" class="art-image">
                                                        <div class="action-icon w-embed">
                                                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a20-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img
                                                            src="https://uploads-ssl.webflow.com/64f20700ae99f7afc1a08523/64f20701ae99f7afc1a08596_Rectangle%2011.png"
                                                            loading="lazy" alt="" class="art-image">
                                                        <div class="action-icon w-embed">
                                                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="collection">
                                            <div class="art-card-context alt">
                                                <div class="content-wrap">
                                                    ...
                                                    <p class="text-color-grey">Create a starwars-like ai assistant with
                                                        legs</p>
                                                </div>
                                                <div class="action-group">
                                                    <div data-hover="false" data-delay="0"
                                            ...
                                            <div class="w-layout-grid _3-col-grid scroll-grid">
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a3a-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img src="/images/Rectangle-13.png"
                                                                               loading="lazy" alt="" class="art-image">
                                                        <div class="action-icon w-embed">
                                                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a3e-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img src="/images/Rectangle-12.png"
                                                                               loading="lazy" alt="" class="art-image">
                                                        <div class="action-icon w-embed">
                                                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a id="w-node-_310b1e3a-efa8-db61-8866-6a8cc4c06a42-6e2eeeab" href="#"
                                                   class="w-inline-block">
                                                    <div class="art-card"><img
                                                            src="https://uploads-ssl.webflow.com/64f20700ae99f7afc1a08523/64f20701ae99f7afc1a08597_Rectangle%2011.png"
                                                            loading="lazy" alt="" class="art-image">
                                                        <div class="action-icon w-embed">
                                                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
